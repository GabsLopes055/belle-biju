...
revo-grid[theme=default] revogr-data .revo-draggable,
...
revo-grid[theme=material] revogr-header .header-rgRow {
  height: 50px;
}
...
revo-grid[theme=darkMaterial] revogr-header .rgHeaderCell {
  padding: 0 15px;
  text-overflow: ellipsis;
}
revo-grid[theme=darkMaterial] revogr-header .header-rgRow {
  height: 50px;
}
...
revo-grid[theme=darkCompact] revogr-header .rgHeaderCell {
  padding: 0 15px;
  text-overflow: ellipsis;
}
revo-grid[theme=darkCompact] revogr-header .header-rgRow {
  height: 45px;
}
...
revo-grid[theme=compact] revogr-header .rgHeaderCell {
  padding: 0 15px;
  text-overflow: ellipsis;
}
revo-grid[theme=compact] revogr-header .header-rgRow {
  height: 45px;
}
...
revo-grid .attribution:hover .value {
  width: 63px;
  opacity: 1;
}
revo-grid.column-draggable.column-drag-start:hover, revo-grid.column-draggable.column-drag-start *:hover {
  cursor: grabbing;
}
