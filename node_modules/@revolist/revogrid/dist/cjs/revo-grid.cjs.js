...
var appGlobals = require('./app-globals-C25fRAbf.js');
...
var patchBrowser = () => {
  const importMeta = (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('revo-grid.cjs.js', document.baseURI).href));
  const opts = {};
  if (importMeta !== "") {
